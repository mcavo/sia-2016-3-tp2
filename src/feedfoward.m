...
%
% Output:
% o:	Activation values of the neurones - cell array

function o = feedfoward(net, in, g, b) 
	layer_in = in;
	for m=1:size(net)(2)
		layer_out{m} = g(b,[(ones(size(layer_in)(1),1)*(-1)) layer_in]*net{m});
		layer_in = layer_out{m};
	end
	o = layer_out;
end
