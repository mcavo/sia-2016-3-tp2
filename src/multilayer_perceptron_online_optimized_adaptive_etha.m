...
% n: etha
% alpha: alpha
function smart_net = multilayer_perceptron_online_optimized_adaptive_etha(net,t,err,g,g_der,betha,n,alpha,a,b,random)
	...
	step = 0; xerr(1) = 0; xetha(1) = 0; yetha(1) = n; yerr(1) = E;
