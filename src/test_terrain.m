function net = test_terrain()
	...
	err=0.001; g=@tanh_ft; g_der=@tanh_ft_der; betha=0.5; n=0.5; alpha=0; a=0; b=0;

	net = multilayer_perceptron_online_adaptive_etha(nett,t,err,g,g_der,betha,n,alpha,a,b);
